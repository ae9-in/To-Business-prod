      ...
      <div className="max-w-[1280px] mx-auto px-6 grid lg:grid-cols-[1fr_1.1fr] gap-20 lg:gap-32 items-center">
        ...
        >
          <div className="col-span-2 relative h-[280px] rounded-[32px] overflow-hidden shadow-sm border border-gray-200/50 group">
            <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=800&q=80" alt="Team working over a laptop" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 opacity-90" />
          ...
          <div className="relative h-[220px] rounded-[32px] overflow-hidden shadow-sm border border-gray-200/50 group">
            <img src="https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&w=400&q=80" alt="Black professionals collaborating" className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-90" />
            <div className="absolute inset-0 bg-indigo-900/20 mix-blend-overlay" />
          </div>
          <div className="relative h-[220px] rounded-[32px] overflow-hidden shadow-sm border border-gray-200/50 group">
            <img src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=400&q=80" alt="Colleagues working" className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-90" />
