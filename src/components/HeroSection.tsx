...
export default function HeroSection() {
  return (
    <section className="bg-[#f8f9ff] py-32 border-b border-[#eef0f6] relative overflow-hidden" style={{ minHeight: '80vh' }}>
      ...
      <div className="absolute inset-0 z-0 select-none pointer-events-none md:pointer-events-auto opacity-30 mix-blend-multiply">
        <Iridescence
          color={[0.5, 0.6, 0.8]}
          mouseReact
          amplitude={0.1}
      ...
      <div className="max-w-[1280px] mx-auto px-6 grid lg:grid-cols-[1fr_1fr] gap-16 md:gap-24 items-center relative z-10">
        ...
        >
          {/* Badge */}
          <motion.div variants={fadeUp} className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-indigo-100 shadow-sm px-5 py-2.5 rounded-full w-max">
          ...
          <motion.h1 variants={fadeUp} className="text-[52px] lg:text-[64px] font-[800] tracking-[-0.02em] leading-[1.05] text-[#0d0d1a] uppercase">
            WHAT IS <br />
            <span className="bg-gradient-to-r from-indigo-600 via-violet-600 to-cyan-500 bg-clip-text text-transparent">TOPTIMIZE ?</span>
          </motion.h1>

          <motion.p variants={fadeUp} className="text-[18px] leading-[1.75] text-[#6b7280] font-[500] max-w-lg">
        ...
        <div className="relative mx-auto w-full max-w-[620px]">
          ...
          <motion.div 
            ...
            className="relative grid gap-5 rounded-[40px] border border-white/60 bg-white/45 p-4 shadow-[0_30px_90px_rgba(96,110,173,0.14)] backdrop-blur-xl sm:grid-cols-[minmax(0,1.14fr)_minmax(0,0.86fr)] sm:p-5 lg:gap-6"
          >
