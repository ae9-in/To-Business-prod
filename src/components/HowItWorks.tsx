      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="relative mt-12 flex justify-center">
          <motion.div 
            ...
            viewport={{ once: true, margin: '-60px' }}
            variants={fadeUp}
            className="w-full max-w-4xl bg-gradient-to-br from-[#f8f9ff] to-white p-10 md:p-14 rounded-[32px] border border-indigo-50 shadow-xl shadow-indigo-900/5 text-center"
          >
